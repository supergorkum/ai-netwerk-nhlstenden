            ...
            {[
              {
                ...
                items: [
                  'Belangrijke bugfix: het AI-Koers rapport toonde na Vernieuwen soms nog verouderde informatie, doordat de achtergrondtaak paginas.json ophaalde zonder de cache te doorbreken. Nu met een tijdstempel en no-cache headers, zodat altijd de actuele versie wordt gebruikt.',
                  'NHL Stenden logo toegevoegd aan de kop van het AI-Koers rapport.',
                  'De rolvraag (docent/student/management/overig) wordt nu altijd getoond bij het starten van een presentatie, in plaats van overgeslagen te worden als er al een rol was onthouden.',
                ],
              },

              {
                versie: 'v2.45', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [

                  'AI-Koers presentatie: omslag en inhoudsopgave waren in de brontekst niet gescheiden en werden daardoor als één, te lange pagina getoond (vervormd verkleind). Nu gesplitst in twee eigen pagina\'s: 17 paginas in totaal in plaats van 16. Let op: bestaande testfeedback per paginanummer schuift hierdoor één op, resetten aanbevolen voor een echte sessie.',
                  'De eerder gerepareerde PowerPoint (met het echte logo) stond nog niet als download op de site zelf, alleen als losse levering. Nu alsnog toegevoegd.',
                ],
              },

              {
                versie: 'v2.44', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [

                  'AI-Koers poster: het echte NHL Stenden logo toegepast (het oude tekst-nagebouwde kader vervangen door het echte logobestand, met een naadloos gereconstrueerde achtergrond).',
                ],
              },

              {
                versie: 'v2.43', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [

                  'AI-Koers document: het tekst-nagebouwde "NHL STENDEN"-kader op de omslag vervangen door het echte logobestand, ingebakken als data-URI. Werkt in het document, de PDF-export en de website (presentatiemodus en documentpagina), zonder los bestandspad.',
                ],
              },

              {
                versie: 'v2.42', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [

                  'Bugfix, waarschijnlijk de oorspronkelijke bron: /initiatieven crashte via InzichtenTab.jsx op "trefwoorden?.length", zelfde denkfout als bij "tags" (v2.41): optional chaining beschermt niet tegen een verkeerd type. Dit is het veld dat Nieuws ophalen vult, dus dit sluit aan bij het allereerste signaal. Nu een expliciete Array.isArray-check, en preventief hetzelfde patroon gerepareerd in BetrokkenenWidget.jsx.',
                ],
              },

              {
                versie: 'v2.41', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [
...

              {
                ...
                items: [
                  ...
                  'AI-Koers presentatie: "Verzenden en afronden" toont nu een echte pop-up met dankbetuiging, die na 2 seconden vanzelf teruggaat naar de hoofdpagina.',
                ],
              },

              {
                versie: 'v2.29', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [
                  'AI-Koers presentatie: bugfix vergrootglas, de inhoud in de lens verschrompelde zonder vaste breedte waardoor die compleet anders werd opgemaakt. Nu gefixt met dezelfde breedte als het origineel.',
                  'AI-Koers presentatie: "niet jij? wijzig"-link bij de rolvraag op het startscherm.',
                  'AI-Koers presentatie: miniatuurafbeelding per pagina in het eindoverzicht.',
                ],
              },

              {
                versie: 'v2.28', datum: 'Juli 2026',
                label: null, labelKleur: '',
                items: [
