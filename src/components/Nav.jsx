      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center h-16 gap-0.5">
            ...
            <NavLink to="/ai-koers-document" className={({isActive}) => `flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors ${isActive ? 'bg-white text-nhl-blauw' : 'bg-white/90 text-nhl-blauw hover:bg-white'}`}>🎤 AI Koers</NavLink>
        ...
        {mob && (
          <div className="lg:hidden border-t border-white/20 py-4">
            ...
            <NavLink to="/ai-koers-document" onClick={() => setMob(false)} className={({isActive}) => `flex items-center gap-2 mx-3 mb-2 px-3 py-2.5 rounded-xl text-sm font-bold transition-colors ${isActive ? 'bg-white text-nhl-blauw' : 'bg-white/90 text-nhl-blauw'}`}>🎤 AI Koers</NavLink>
